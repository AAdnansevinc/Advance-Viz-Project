...
data_barplot_country_top_bottom_union = data %>% 
...
data_barplot_country_top_bottom_union$continent <- reorder(data_barplot_country_top_bottom_union$continent, data_barplot_country_top_bottom_union$HappinessScore)
